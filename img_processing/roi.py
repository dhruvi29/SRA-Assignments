...
img=im.open("SRA-Assignments/img_processing/roi.jpg")
hexme=np.array(img)
h,w,c=hexme.shape
print(hexme.shape)
# hexme[875:1035,1000:1200,0]=0
football=hexme[875:1035,1000:1200]
hexme[850:1010,400:600]=football
hexme=weighted_filter(hexme)
img=im.fromarray(hexme)
im._show(img)